...
export default function Projects(){
    ...
    <div class="rounded overflow-hidden shadow-lg">
      <img class="w-full" src="https://picsum.photos/200/300" alt="Mountain" />
      <div class="px-6 py-4">
    ...
    {/* <!--Card 2--> */}
    <div class="rounded overflow-hidden shadow-lg">
      <img class="w-full" src="https://picsum.photos/200/300" alt="River"/>
      <div class="px-6 py-4">
    ...
    {/* <!--Card 3--> */}
    <div class="rounded overflow-hidden shadow-lg">
      <img class="w-full" src="https://picsum.photos/200/300" alt="Forest"/>
      <div class="px-6 py-4">
